class TwitFeed
	def twitter_update
		...
		# Twitter Hashtag: First 3 Tweets for A Searched Hashtag
		...
		# 3. The search term is then placed into the twitter gem and prints the first 3 tweets with that hashtag
